...
namespace BankMicroservice.Services
{
    public class SadadBankService : IBankService
    {
        ...
        private readonly MeliBankData meliBankData;
            ...
            IBankTransactionService bankTransactionService)
        {
            ...
            _meliBankData = meliBankData.Value;
            _bankTransactionService = bankTransactionService;
            _paymentApi = _meliBankData.PurchaseUrl;
            _verifyApi = _meliBankData.VerifyApi;
            _merchantId = _meliBankData.MerchantId;
            _terminalId = _meliBankdate.TerminalId;
        ...
        public async Task<ReturnModel<PaymentInputDtoResultDto>>  PaymentRequestAsync(PaymentInputDto paymentInput)
        {
            try
            {
